                ...
                <div style={{width:"60vmin",}}>
                    <form onSubmit={this.props.handler}>
                        <div className="form-group regText">
                            ...
                            ></input>
                            <button type="submit" className={this.props.enabled ? "btn-font btn-primary" : "btn-font btn-secondary"} style={!this.props.enabled?{cursor:"not-allowed"}:{cursor:"pointer"}} disabled={!this.props.enabled}>
